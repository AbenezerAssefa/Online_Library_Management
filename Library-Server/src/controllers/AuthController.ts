...
async function handleRegister(reg: Request, res: Response) { 
    const user: IUser = reg.body; 
    try {
...
export default { handleRegister, handleLogin }; // Corrected export to include both functions
